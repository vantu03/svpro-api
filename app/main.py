...
from app.routers import auth, user, common, tool, shipper, upload, notification, websocket, sender, conversations
...
app.include_router(tool.router, prefix="/t", tags=["tool"])
